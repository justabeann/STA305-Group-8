...
```
## Test Statistic
$F= \frac{MSab}{MSE} = 1.0199$~$F_{6,94}$
...
### Kernel Effect
$F= \frac{MSkernel}{MSE} = 5.7579$~$F_{3,100}$

$p= P (F_{3,100}>F)= 0.001127 < 0.05$
  
### Oil effect
$F= \frac{MSoil}{MSE} = 0.8720$~$F_{2,100}$

$p= P (F_{2,100}>F)= 0.421257> 0.05$
